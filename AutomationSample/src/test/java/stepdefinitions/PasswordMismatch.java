...
public class PasswordMismatch {
	...
	public void registration_form_is_loaded() throws Throwable {
	    driver.get(Configuration.getProperty("url"));
	    driver.manage().window().maximize();
	}
	
	@When("^the user fills out the form but$")
    public void the_user_fills_out_the_form_with_valid_inputs() throws Throwable {
		...
		@When("^types password and re-enteres mismatching password$")
		public void types_password_and_re_enteres_mismatching_password() throws Throwable {
		page.aboutYourself.sendKeys(Configuration.getProperty("aboutyourself"));
		page.passwordInput.sendKeys(Configuration.getProperty("yourpassword"));
		page.passwordConfirm.sendKeys(Configuration.getProperty("passwordagain2"));
		page.submit.click();   
		}

		@Then("^Password mismatch message should appear$")
		public void password_mismatch_message_should_appear() throws Throwable {
		    Assert.assertTrue(page.notMatch.isDisplayed());
		}
