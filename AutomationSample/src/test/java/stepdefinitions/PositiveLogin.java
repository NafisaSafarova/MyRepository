...
public class PositiveLogin {
	...
	Success successPage = new Success();
	...
	public void registration_page_is_loaded() throws Throwable {
	    ...
	    @When("^the user fills out the form with valid inputs$")
	    public void the_user_fills_out_the_form_with_valid_inputs() throws Throwable {
			...
			page.profPic.sendKeys(jpgFile);;
	  	    ...
	  	    page.passwordConfirm.sendKeys(Configuration.getProperty("passwordagain"));
	  	   
	    }

	    @Then("^the user should be able to successfully submit the form$")
	    public void the_user_should_be_able_to_successfully_submit_the_form() throws Throwable {
	        page.submit.click();
	        Assert.assertTrue(successPage.message.isDisplayed());
	    }
