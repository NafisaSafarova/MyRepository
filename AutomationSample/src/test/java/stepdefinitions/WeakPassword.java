...
public class WeakPassword {
	...
	@When("^enters \"([^\"]*)\"$")
	public void enters(String weakpassword) throws Throwable {
	   page.passwordInput.sendKeys(weakpassword);
	   page.passwordConfirm.sendKeys(weakpassword);
	}

	@Then("^corresponding weak password message should appear$")
	public void corresponding_weak_password_message_should_appear() throws Throwable {
		page.submit.click();
		Assert.assertTrue(page.weakPassword.isDisplayed());
	}
